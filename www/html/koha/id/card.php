...
class student{
	public $bno,$cardnumber,$name,$address,$mob1,$mob2,$branch,$blood,$batch,$isF,$f1,$f2,$f3,$f4,$s1,$s2;
	public function __construct($s,$isF){
		...
		if($isF){
			...
			$this->f2 = 'Designation';
			$this->f3 = 'Department';
			$this->f4 = 'Staff/Faculty members';
		}else{
			$this->f1 = 'Student No.';
			$this->f2 = 'Course/Branch';
			$this->f3 = 'Batch';
			$this->f4 = 'Students';
			$this->getBatch();
			$this->getBranch();
...
<div id="container">
	<div id="main" >
		...
		if (isset($_POST['submit'])&&sizeof($_POST)>=2) {			
			if(isset($_POST['isfaculty'])&&$_POST['isfaculty']=='on'){
				$isfaculty = true;
			}
